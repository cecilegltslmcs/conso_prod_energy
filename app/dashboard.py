...
app.layout = html.Div([
    ...
    html.Div(
        children="Cette application permet de visualiser les données de consommation "
                 "et de production d'énergie région par région. Les données présentées sont actualisées toutes les 15 "
                 "minutes.",
        style={
            'textAlign': 'justify',
        }),
